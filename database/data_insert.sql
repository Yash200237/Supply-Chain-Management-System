...
-- Insert into Train
INSERT INTO Train (time, day, capacity,remainingCapacity, destination) VALUES
('08:00:00', 'Monday', 50, 50, 'Colombo'),        -- 1
('14:00:00', 'Monday', 55,55, 'Negombo'),        -- 2
('08:00:00', 'Tuesday', 50,50, 'Galle'),         -- 3
('14:00:00', 'Tuesday', 55,55, 'Matara'),        -- 4
('08:00:00', 'Wednesday', 45,45, 'Jaffna'),      -- 5
('14:00:00', 'Wednesday', 50,50, 'Trincomalee'), -- 6
('08:00:00', 'Thursday', 50,50, 'Colombo'),      -- 7
('14:00:00', 'Thursday', 50,50, 'Negombo'),      -- 8
('08:00:00', 'Friday', 45,45, 'Galle'),          -- 9
('14:00:00', 'Friday', 40,40, 'Matara'),         -- 10
('08:00:00', 'Saturday',50,50, 'Jaffna'),       -- 11
('14:00:00', 'Saturday', 50,50, 'Trincomalee'),  -- 12
('08:00:00', 'Sunday', 50,50, 'Colombo'),        -- 13
('14:00:00', 'Sunday', 55,55, 'Negombo');        -- 14
...
INSERT INTO TruckSchedule (driver_ID, driverA_ID, truck_Id, route_ID, time, date, manager_ID,filled_capacity, status) VALUES
(15, 4, 13, 15, '08:00:00', '2024-09-04', 6, 0.05 , 'completed'), -- 1
(1, 18, 3, 1, '08:00:00', '2024-09-04', 1, 0.05 , 'completed'),   -- 2      
(4, 15, 5, 4, '08:30:00', '2024-09-05', 2, 0.26 ,'completed'),   -- 3
(2, 17, 2, 2, '09:00:00', '2024-09-05', 1, 0.12 , 'completed'),   -- 4
(5, 14, 6, 5, '09:30:00', '2024-09-05', 2, 0.42 , 'completed'),   -- 5
(18, 1, 16, 18, '08:30:00', '2024-09-06', 7, 0.24 , 'completed'), -- 6
(10, 9, 10, 10, '09:00:00', '2024-09-08', 4, 0.04 , 'completed'), -- 7
(1, 18, 3, 1, '08:00:00', '2024-09-08', 1, 0.22 , 'completed'),   -- 8     
(11, 8, 12, 11, '08:00:00', '2024-09-08', 5, 0.23 , 'completed'), -- 9
(15, 4, 13, 15, '08:00:00', '2024-09-09', 6, 0.18 , 'completed'), -- 10
(14, 5, 15, 14, '09:00:00', '2024-09-09', 6, 0.41 , 'completed'), -- 11  
(11, 8, 12, 11, '08:00:00', '2024-09-10', 5, 0.34 , 'completed'), -- 12
(7, 12, 9, 7, '08:00:00', '2024-09-11', 3, 0.40 , 'completed'),   -- 13
(4, 15, 5, 4, '08:30:00', '2024-09-13', 2, 0.22 , 'completed'),   -- 14
(2, 17, 2, 2, '09:00:00', '2024-09-13', 1, 0.05 , 'completed'),   -- 15
(17, 2, 17, 17, '08:00:00', '2024-09-14', 7, 0.10 , 'completed'), -- 16
(3, 16, 1, 3, '08:30:00', '2024-09-14', 2, 0.16 , 'completed'),   -- 17
(6, 13, 4, 6, '08:30:00', '2024-09-15', 3, 0.60 , 'completed'),   -- 18
(7, 12, 9, 7, '08:00:00', '2024-09-16', 3, 0.49 , 'completed'),   -- 19
(9, 10, 7, 9, '09:00:00', '2024-09-16', 4, 0.36 , 'completed'),   -- 20
(8, 11, 8, 8, '08:30:00', '2024-09-17', 3, 0.19 , 'completed'),   -- 21
(10, 9, 10, 10, '09:00:00', '2024-09-17', 4, 0.39 , 'completed'), -- 22
(5, 14, 6, 5, '09:30:00', '2024-09-18', 2, 0.40 , 'completed'),   -- 23
(16, 3, 18, 16, '09:30:00', '2024-09-19', 7, 0.27 ,'completed'), -- 24
(17, 2, 17, 17, '08:00:00', '2024-09-20', 7, 0.08 , 'completed'), -- 25
(12, 7, 11, 12, '08:30:00', '2024-09-21', 5, 0.64 , 'completed'), -- 26
(6, 13, 4, 6, '08:30:00', '2024-09-21', 3, 0.10 , 'completed'),   -- 27
(13, 6, 14, 13, '08:00:00', '2024-09-21', 5, 0.04 , 'completed'), -- 28
(14, 5, 15, 14, '09:00:00', '2024-09-23', 6, 0.13 , 'completed'), -- 29
(16, 3, 18, 16, '09:30:00', '2024-09-24', 7, 0.23 , 'completed'), -- 30
(3, 16, 1, 3, '08:30:00', '2024-09-24', 2, 0.31 , 'completed'),   -- 31 
(18, 1, 16, 18, '08:30:00', '2024-09-25', 7, 0.31 , 'completed'), -- 32
(9, 10, 7, 9, '09:00:00', '2024-09-25', 4, 0.05 ,'completed'),   -- 33
(12, 7, 11, 12, '08:30:00', '2024-09-26', 5, 0.32 , 'completed'), -- 34
(13, 6, 14, 13, '08:00:00', '2024-09-27', 5, 0.13 , 'completed'), -- 35
(8, 11, 8, 8, '08:30:00', '2024-09-28', 3, 0.24 , 'completed'),   -- 36
(3, 16, 1, 3, '08:30:00', '2024-09-29', 2, 0.17 , 'completed'),   -- 37
(13, 6, 14, 13, '08:00:00', '2024-09-29', 5, 0.40 , 'completed'), -- 38
(7, 12, 9, 7, '08:00:00', '2024-09-30', 3, 0.56 , 'completed'),   -- 39
(8, 11, 8, 8, '08:30:00', '2024-09-30', 3, 0.02 , 'completed'),   -- 40
(11, 8, 12, 11, '08:00:00', '2024-10-01', 5, 0.58 , 'completed'), -- 41
(1, 18, 3, 1, '08:00:00', '2024-10-02', 1, 0.63 , 'completed'),   -- 42
(5, 14, 6, 5, '09:30:00', '2024-10-03', 2, 0.24 , 'completed'),   -- 43
(18, 1, 16, 18, '08:30:00', '2024-10-03', 7, 0.17 , 'completed'), -- 44
(4, 15, 5, 4, '08:30:00', '2024-10-04', 2, 0.20 , 'completed'),   -- 45
(14, 5, 15, 14, '09:00:00', '2024-10-05', 6,  0.23 , 'completed'), -- 46
(15, 4, 13, 15, '08:00:00', '2024-10-05', 6,  0.11 , 'completed'), -- 47
(6, 13, 4, 6, '08:30:00', '2024-10-06', 3, 0.36 , 'completed'),   -- 48
(12, 7, 11, 12, '08:30:00', '2024-10-07', 5, 0.30 , 'completed'), -- 49
(16, 3, 18, 16, '09:30:00', '2024-10-07', 7, 0.44 , 'completed'), -- 50
(1, 3, 10, 2, '08:00:00', '2024-11-01', 6, 0, 'scheduled'), -- 51
(2, 4, 11, 3, '09:30:00', '2024-11-02', 7, 0, 'scheduled'), -- 52
(3, 5, 12, 4, '07:45:00', '2024-11-03', 1, 0, 'scheduled'), -- 53
(1, 6, 13, 5, '10:15:00', '2024-11-04', 3, 0, 'scheduled'), -- 54
(2, 7, 14, 6, '11:00:00', '2024-11-05', 7, 0, 'scheduled'), -- 55
(15, 4, 13, 15, '08:00:00', '2024-10-22', 6, 9.00, 'completed'),  -- 56
(1, 18, 3, 1, '08:00:00', '2024-10-22', 1, 9.60, 'completed'),    -- 57
(4, 15, 5, 4, '08:30:00', '2024-10-23', 2, 9.80, 'completed'),    -- 58
(2, 17, 2, 2, '09:00:00', '2024-10-23', 1, 10.10, 'completed'),    -- 59
(5, 14, 6, 5, '09:30:00', '2024-10-24', 2, 10.00, 'completed'),    -- 60
(10, 9, 10, 10, '09:00:00', '2024-10-25', 4, 9.80, 'completed'),  -- 61
(7, 12, 9, 7, '08:00:00', '2024-10-25', 3, 9.50, 'completed'),    -- 62
(3, 16, 1, 3, '08:30:00', '2024-10-26', 2, 9.70, 'completed'),    -- 63
(18, 1, 16, 18, '08:30:00', '2024-10-27', 7, 9.90, 'completed'),  -- 64
(13, 6, 14, 13, '08:00:00', '2024-10-27', 5, 10.30, 'completed'),  -- 65
(9, 10, 7, 9, '09:00:00', '2024-10-28', 4, 9.60, 'completed'),    -- 66
(12, 7, 11, 12, '08:30:00', '2024-10-28', 5, 9.50, 'completed');  -- 67
...
INSERT INTO `TrainSchedule` (train_ID, order_ID, manager_ID,departureDate) VALUES
(11, 1, 1,'2024-08-30' ),    -- 8/31
(13, 3, 1,'2024-08-31'),    -- 8/31
(13, 5, 1,'2024-08-31'),    -- 8/31
(12, 6, 1,'2024-09-01'),    -- 8/31
(3, 7, 1,'2024-09-03'),     -- 9/3
(4, 9, 1,'2024-09-03'),     -- 9/3
(5, 10, 1,'2024-09-04'),    -- 9/4
(5, 11, 1,'2024-09-04'),    -- 9/4
(10, 12, 1,'2024-09-05'),   -- 9/6
(8, 13, 1,'2024-09-06'),    -- 9/5
(13, 14, 1,'2024-09-08'),   -- 9/8
(12, 16, 1,'2024-09-09'),   -- 9/7
(13, 17, 1,'2024-09-09'),   -- 9/8
(14, 18, 1,'2024-09-10'),   -- 9/8
(2, 19, 1,'2024-09-11'),    -- 9/9
(3, 20, 1,'2024-09-11'),    -- 9/10
(8, 21, 1,'2024-09-12'),    -- 9/12
(3, 22, 1,'2024-09-12'),    -- 9/10
(7, 23, 1,'2024-09-13'),    -- 9/12
(12, 24, 1,'2024-09-14'),   -- 9/14
(12, 25, 1,'2024-09-15'),   -- 9/14
(4, 26, 1,'2024-09-16'),    -- 9/17
(14, 27, 1,'2024-09-16'),   -- 9/15
(4, 28, 1,'2024-09-16'),    -- 9/17
(5, 29, 1,'2024-09-18'),    -- 9/18
(6, 30, 1,'2024-09-19'),    -- 9/18
(9, 31, 1,'2024-09-19'),    -- 9/19   
(12, 32, 1,'2024-09-20'),   -- 9/21
(9, 33, 1,'2024-09-20'),    -- 9/20
(10, 34, 1,'2024-09-21'),   -- 9/20
(4, 35, 1,'2024-09-22'),    -- 9/24    
(14, 36, 1,'2024-09-23'),   -- 9/22
(1, 37, 1,'2024-09-24'),    -- 9/23
(4, 38, 1,'2024-09-24'),    -- 9/24
(2, 39, 1,'2024-09-25'),    -- 9/23  
(2, 40, 1,'2024-09-26'),    -- 9/23  
(4, 41, 1,'2024-09-27'),    -- 9/24 
(7, 43, 1,'2024-09-28'),    -- 9/26
(12, 44, 1,'2024-09-28'),   -- 9/28 
(13, 45, 1,'2024-09-29'),   -- 9/29 
(11, 46, 1,'2024-09-30'),   -- 9/28
(5, 47, 1,'2024-09-30'),    -- 10/2
(2, 48, 1,'2024-10-01'),    -- 9/30
(4, 49, 1,'2024-10-02'),    -- 10/1  
(6, 50, 1,'2024-10-02');    -- 10/2
